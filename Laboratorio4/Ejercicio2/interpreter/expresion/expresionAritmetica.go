...
// fmt.Println(tr)
// fmt.Println(cad1 + " <--> " + cad2)
// if tr == tipos.STRING {
// 	fmt.Println(cad1 + cad2)
// 	return cad1 + cad2
// } else

// v1, _ := strconv.ParseInt(cad1, 10, 64)
// v2, _ := strconv.ParseInt(cad2, 10, 64)
// fmt.Println(v1 + v2)
// return strconv.Itoa(int(v1 + v2))

// } else if t1.ToString() == tipos.INT || t2.ToString() == tipos.INT {
// 	nt := tipos.NewTipo(tipos.INT)
// 	return &nt
// }

...
// NewEjercicio1Lexer produces a new lexer instance for the optional input antlr.CharStream.
//
// The *Ejercicio1Lexer instance produced may be reused by calling the SetInputStream method.
